...
export function NodeTooltip({
  ...
  return (
    <div
      className={`absolute z-40 w-72 max-w-[calc(100vw-2rem)] rounded-2xl border border-white/12 bg-black/95 px-5 py-4 text-left shadow-[0_24px_64px_rgba(0,0,0,0.6)] backdrop-blur-md ${placement}`}
      onMouseEnter={() => {
        clearTooltipClose();
